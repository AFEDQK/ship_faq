...
assert task_name in ['ATEC', 'BQ', 'LCQMC', 'PAWSX', 'STS-B', 'BySelf']
...
# 加载数据集
data_path = 'data/ship_performance_QA.csv'
...
encoder.fit(
    train_generator.forfit(), steps_per_epoch=len(train_generator), epochs=10, callbacks=[evaluator]
)
